...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/javascript/mainCalc.js":[function(require,module,exports) {
var a = '';
var b = '';
var sign = '';
var finish = false;
...
var calculation = document.querySelector('.calc-screen span');
...
btn.addEventListener('click', function (event) {
  ...
  if (digit.includes(key)) {
    ...
    calculation.textContent = "".concat(a, " ").concat(sign, " ").concat(b);
    return;
  }
  ...
  if (action.includes(key)) {
    sign = key;
    out.textContent = "= ".concat(a);
    calculation.textContent = "".concat(a, " ").concat(sign);
  }
...
require("./mainCalc");
},{"./mainCalc":"src/javascript/mainCalc.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
